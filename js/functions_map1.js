...
// MODAL prev and next
    ...
    function ShowAllAreas() {
        ...
        for (i = 0; i < SOP.length; i++) {
            ...
            $('#sortab').append('<div class="well span2 tile" name="order_areas" id="' + SOP[i].name + '"> <span class="glyphicon glyphicon-move" aria-hidden="true" style="margin-right:10px"></span> Area ' + SOP[i].name + '</div>');
